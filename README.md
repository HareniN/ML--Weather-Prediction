...
## Algorithm
1.Collect and preprocess environmental sensor data (temperature, humidity, PM2.5, energy usage, etc.).

2.Split the dataset into training and testing sets.

3.Train the Random Forest model using the training data for prediction of temperature, PM2.5, and energy.

4.Test the model on unseen data and evaluate performance using metrics like accuracy or RMSE.
...
## Output:
<img width="1910" height="1063" alt="Screenshot 2026-03-19 144203" src="https://github.com/user-attachments/assets/9ca03d48-f3ee-4dcb-a822-f62afa592bf4" />

<img width="1889" height="578" alt="Screenshot 2026-03-19 144225" src="https://github.com/user-attachments/assets/c2c91b74-83ac-4d8d-bd34-bd19a02c9cfb" />
